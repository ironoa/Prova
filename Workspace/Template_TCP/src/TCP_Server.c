/*
 ...
 ESEMPIO	 : Server che riceve un file e lo ridirige ordinato al client, FILTRO, EXECL
 ============================================================================
*/
	...
	*/
	...
	for(;;){ 
		...
		* corrisponde la costante EINTR!*/
		...
		close(conn_sd);  // padre chiude socket di connessione non di scolto, il figlio è andato in execl non lo portrà fare
	} // ciclo for infinito
	/********************************************************/
